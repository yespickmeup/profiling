...
import city_planning.reports_backup.*;
 ...
 * @author Guinness
 */
public class Dlg_report_barangay_clearances extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_barangay_clearances(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_barangay_clearances(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_barangay_clearances() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_barangay_clearances myRef;

    private void setThisRef(Dlg_report_barangay_clearances myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_barangay_clearances> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_barangay_clearances create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_barangay_clearances create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_barangay_clearances dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_barangay_clearances((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_barangay_clearances((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_barangay_clearances dialog = Dlg_report_barangay_clearances.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (Barangay_clearances.to_barangay_clearances to : datas) {
                    ...
                    Srpt_barangay_clearances.field field = new Srpt_barangay_clearances.field(clearance_no, date, citizen, purpose, is_fixed, amount);
                    fields.add(field);
                }
                ...
                try {
                    ...
                    Logger.getLogger(Dlg_report_barangay_clearances.class.getName()).
    ...
    private void report_without_fields(final Srpt_barangay_clearances to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_expenses(Srpt_barangay_clearances to, String rpt_name) {
        try {
