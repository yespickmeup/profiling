 ...
 * @author Guinness
 */
public class Srpt_survey_form_h1 {
    ...
    public Srpt_survey_form_h1(String province, String city, String barangay, String img_city, String img_barangay) {
    ...
    public static JRViewer get_viewer(Srpt_survey_form_h1 to, String jrxml) {
