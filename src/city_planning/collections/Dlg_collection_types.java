...
import city_planning.collections.Collection_types.to_collection_types;
 ...
 * @author Guinness
 */
public class Dlg_collection_types extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_collection_types(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_collection_types(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_collection_types myRef;

    private void setThisRef(Dlg_collection_types myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_collection_types> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_collection_types create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_collection_types create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_collection_types dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_collection_types((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_collection_types((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_collection_types dialog = Dlg_collection_types.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    private void ret_collection_types() {
        String where = "";
        List<to_collection_types> datas = Collection_types.ret_data(where);
    ...
    private void select_collection_types() {
        ...
        tf_collection_type.setText(to.collection_type);
    ...
    private void update_collection_types() {
        ...
        Collection_types.update_data(to1);
        Alert.set(2, "");
        ret_collection_types();
        tf_collection_type.setText("");
        tf_amount_due.setText("");
    ...
    private void delete_collection_types() {
        ...
        nd.setCallback(new Dlg_confirm_action.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                closeDialog.ok();
                Collection_types.delete_data(to);
                Alert.set(3, "");
                ret_collection_types();
                tf_collection_type.setText("");
                tf_amount_due.setText("");
